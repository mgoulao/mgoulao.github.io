/*
These are HTML strings. JavaScript functions will
replace the %data% placeholder text.
*/
var HTMLheaderName = '<h1 id="name">%data%</h1>';
var HTMLheaderRole = '<span>%data%</span></br></br>';
...
var HTMLprojectStart = '<div class="project-entry mg-cv-card %color%"></div>';
...
var HTMLprojectOverlay = '<div class="mg-card-overlay %data%">%content%</div>';
var HTMLprojectTitle = '<div class="mg-project-title">%data%</div>';
